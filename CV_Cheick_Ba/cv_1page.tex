...
\begin{itemize}
    ...
    Topic: large-scale data analysis with temporal networks, algorithms, and data visualisation.  
...
%---------------------------------------------------------
  \cvskill
    ...
    {Python (Advanced), Rust(Intermediate), JavaScript (Advanced), SQL, Java, PHP, Perl, Latex } % Skills
...
%---------------------------------------------------------
  \cvskill
    ...
    {Basketball, hiking, board games, swimming, reading} 
\end{cvskills}
