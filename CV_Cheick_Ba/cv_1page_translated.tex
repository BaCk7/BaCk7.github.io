...
\begin{itemize}
    ...
    Analisi di dati su larga scala con reti temporali, algoritmi e visualizzazione dei dati.  
...
%---------------------------------------------------------
  \cvskill
    ...
    {Python (Avanzato), JavaScript (Avanzato), Rust (Intermedio), SQL, Java, PHP, Perl, Latex } % Skills
...
%---------------------------------------------------------
  \cvskill
    ...
    {Basket, escursioni, giochi da tavolo, nuoto, lettura} 
\end{cvskills}
